...
### 설치 과정  
![](https://github.com/jseomP/PMI/blob/main/images/01.png)  
바로 `Try or install Ubuntu` 선택되어있다. 엔터로 빨리넘어가자.  
그럼 잠시뒤에, 해파리가 여러분을 반겨줄 것이다. 으... 징그러운 것.  
  
![](https://github.com/jseomP/PMI/blob/main/images/02.png)  
...
![](https://github.com/jseomP/PMI/blob/main/images/03.png)  
잠깐동안만 미국인이라고 자기 최면을 걸자. `Continue`를 클릭한다.  
  
![](https://github.com/jseomP/PMI/blob/main/images/04.png)  
...
![](https://github.com/jseomP/PMI/blob/main/images/05.png)    
...
![](https://github.com/jseomP/PMI/blob/main/images/06.png)    
...
![](https://github.com/jseomP/PMI/blob/main/images/07.png)    
...
![](https://github.com/jseomP/PMI/blob/main/images/08.png)    
우선, 부팅 공간을 위한 `efi` 또는 `boot` 설정이다. 512MB 정도 설정하면 부팅이미지가 5개 정도 들어가는 용량이다.  
여기서는 UEFI 시스템을 사용해서, `efi`파티션을 생성한다.  

![](https://github.com/jseomP/PMI/blob/main/images/08-1.png)    
만약 MBR의 Legacy 구성이라면, 위와 같이 `boot`파티션을 생성하면된다.  
  
![](https://github.com/jseomP/PMI/blob/main/images/09.png)    
다음으로 `swap` 파티션을 생성한다.  
...
![](https://github.com/jseomP/PMI/blob/main/images/10.png)    
...
![](https://github.com/jseomP/PMI/blob/main/images/11.png)     
`Device for boot loader installation`은 아까 부팅파티션을 지정해준 `/dev/nvme0n1p1`으로 설정하면 된다.  
물론, PC마다 설정 값이 다르니 해당 파티션을 설정해 주면 된다.  
그리고 `Install Now`!

![](https://github.com/jseomP/PMI/blob/main/images/12.png)     
최종 확인이다. 그대로 따라했다면 문제가 없으니, `Continue`를 누른다.  

![](https://github.com/jseomP/PMI/blob/main/images/13.png)     
시간대 설정이다. `Continue`  

![](https://github.com/jseomP/PMI/blob/main/images/14.png)    
계정 설정이다.  
...
---
### 우분투 내부 설정  
![](https://github.com/jseomP/PMI/blob/main/images/20.png)  
온라인 계정 설정 창인데, 여지껏 리눅스를 설치하면서 한번도 연동한 적이 없다...  
`Skip`을 누른다.  

![](https://github.com/jseomP/PMI/blob/main/images/21.png)  
우분투 개발에 있어서 시스템 사용 패턴이나 관련 정보를 공유하는 곳이다.  
`No, don't sent system info`로 혼자 살아보자. 그 다음 `Next`  

![](https://github.com/jseomP/PMI/blob/main/images/22.png)  
스마트폰의 위치기반 서비스로 이해하면 편하다. 그냥 `Next`  

![](https://github.com/jseomP/PMI/blob/main/images/23.png)    
...
![](https://github.com/jseomP/PMI/blob/main/images/24.png)  
좌상단의 `Activities`(현재 활동)을 클릭해서, 검색창에 `Language` 검색하고, 실행시킨다.  

![](https://github.com/jseomP/PMI/blob/main/images/25.png)  
사용가능한 언어정보를 확인할 수 없다는 팝업창이 표시된다. `Update`를 누르고, 잠시 기다려준다.  

![](https://github.com/jseomP/PMI/blob/main/images/26.png)  
미리 설정된 언어 파일이 완전히 설치되지 않았다는 팝업창이 표시된다. `Install`  

![](https://github.com/jseomP/PMI/blob/main/images/27.png)  
계정 비밀번호를 입력해준다. 이제 프로그램을 설치할때나 설정을 변경할때 자주 표시될 예정이다. (좀 귀찮다.)  
그리고 `Authenticate`를 누르고, 잠시 기다려준다.  

![](https://github.com/jseomP/PMI/blob/main/images/28.png)  
...
![](https://github.com/jseomP/PMI/blob/main/images/29.png)  
...
![](https://github.com/jseomP/PMI/blob/main/images/30.png)  
한글이 보인다! 라고 로그인! 끝! 인줄 알았는데....  

![](https://github.com/jseomP/PMI/blob/main/images/31.png)  
...
![](https://github.com/jseomP/PMI/blob/main/images/32.png) 

그럼 진짜 끝. 
![](https://github.com/jseomP/PMI/blob/main/etc/bye.webp) 
